...
HD_PWD='C:/Users/ADMIN/OneDrive/GitHub/HCMUT_LSI_Lab/Lab_1/Bounce_flash/Bounce_flash.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Bounce_flash.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Bounce_flash.tcl -notrace
