...
HD_PWD='C:/Users/ADMIN/OneDrive/GitHub/HCMUT_LSI_Lab/Lab_1/Bounce_flash/Bounce_flash.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Bounce_flash.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Bounce_flash.tcl
