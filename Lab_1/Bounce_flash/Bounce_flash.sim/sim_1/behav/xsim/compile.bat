...
REM
REM Generated by Vivado on Tue Mar 05 13:54:12 +0700 2024
...
echo "xvlog --incr --relax -prj Bounce_flash_tb_vlog.prj"
call xvlog  --incr --relax -prj Bounce_flash_tb_vlog.prj -log xvlog.log
