...
REM
REM Generated by Vivado on Mon Mar 04 10:14:51 +0700 2024
...
echo "xvlog --incr --relax -prj led_sequence_tb_vlog.prj"
call xvlog  --incr --relax -prj led_sequence_tb_vlog.prj -log xvlog.log
